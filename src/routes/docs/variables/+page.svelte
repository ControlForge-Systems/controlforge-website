...
<svelte:head>
	...
	<meta
		name="description"
		content="Learn about variable declarations, initialization, and data types in IEC 61131-3 Structured Text including BOOL, INT, REAL, STRING, and more."
	/>
	<CanonicalLink path="/docs/variables" />
	<ArticleSchema
		headline="Variables & Data Types"
		description="Learn about variable declarations, initialization, and data types in IEC 61131-3 Structured Text including BOOL, INT, REAL, STRING, and more."
		url="/docs/variables"
	/>
</svelte:head>
...
END_VAR`}
			...
			<div class="text-sm text-gray-600 mt-3">
				...
				<div><strong>DINT:</strong> -2³¹ to 2³¹-1 (32-bit)</div>
...
END_VAR`}
	...
	<div class="mb-6">
		<div class="bg-green-50 border border-green-200 rounded-lg p-6 mb-6">
			<h3 class="text-lg font-semibold text-green-800 mb-3">✅ Good Practices</h3>
			<CodeExample
				code={`VAR
...
END_VAR`}
		...
		<div class="bg-red-50 border border-red-200 rounded-lg p-6 mb-6">
			<h3 class="text-lg font-semibold text-red-800 mb-3">❌ Potential Issues</h3>
			<CodeExample
				code={`VAR
...
END_VAR`}
	...
	<p class="text-gray-700 mb-4">Arrays allow you to store multiple values of the same type:</p>
...
Matrix[2,3] := 42;`}
	...
	<p class="text-gray-700 mb-4">Structures allow you to group related data together:</p>
...
// Numeric conversions
RealValue := INT_TO_REAL(IntValue);     // 42 → 42.0
IntValue := REAL_TO_INT(25.7);          // 25.7 → 25

// String conversions
StringValue := INT_TO_STRING(IntValue); // 42 → '42'
IntValue := STRING_TO_INT('123');       // '123' → 123
...
IntValue := BOOL_TO_INT(TRUE);          // TRUE → 1`}
		...
		<div class="flex">
			...
			<div class="ml-3">
				...
				<ul class="text-yellow-700 text-sm space-y-1">
					<li>• Check for potential data loss (e.g., REAL to INT truncates)</li>
					<li>• Validate string-to-number conversions for invalid input</li>
					<li>• Consider range limits when converting between integer types</li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="mb-6">
		<div class="bg-green-50 border border-green-200 rounded-lg p-6 mb-6">
			<h3 class="text-lg font-semibold text-green-800 mb-3">✅ Naming Conventions</h3>
			<CodeExample
...
sPartNumber : STRING;   // String`}
		...
		<div class="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
			<h3 class="text-lg font-semibold text-blue-800 mb-3">💡 Initialization Tips</h3>
			<CodeExample
...
END_VAR`}
	...
	<div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
		...
		<div class="space-y-2">
			...
			>
				→ Complete Data Types Reference (BYTE, WORD, DWORD, LWORD, POINTER, etc.)
			</a>
			<a
				href="/docs/control"
				class="block text-sm text-brand-blue hover:text-blue-800 transition-colors"
			>
				→ Control Structures (IF, CASE, FOR, WHILE)
			</a>
			<a
