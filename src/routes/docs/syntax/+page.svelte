...
<article class="prose prose-lg max-w-none">
  ...
  <p class="text-gray-700 mb-6">
    Structured Text follows a clear, readable syntax similar to Pascal or other high-level programming languages. 
    Understanding these fundamental rules will help you write clean, maintainable ST code.
  </p>
  ...
  <div class="bg-gray-50 rounded-lg p-6 mb-6">
    ...
    <p class="text-gray-700 mb-4">Every statement in Structured Text must end with a semicolon (;):</p>
...
Timer1(IN := StartSignal, PT := T#5s);`}
  ...
  <p class="text-gray-700 mb-4">
    ST supports two types of comments for documenting your code. Good commenting is essential for maintaining 
    industrial automation systems over their long operational lifespans.
  </p>

  <div class="mb-6">
    <div class="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
      <h3 class="text-lg font-semibold text-blue-800 mb-3">Single-line Comments</h3>
      <p class="text-sm text-blue-700 mb-3">Use // for brief explanations and inline documentation:</p>
      <CodeExample 
...
END_IF;`}
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
      ...
      <p class="text-sm text-blue-700 mb-3">Use (* *) for detailed documentation and code blocks:</p>
      <CodeExample 
        code={`(*
...
END_IF;`}
  ...
  <div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
    ...
    <div class="space-y-2">
      <a href="/docs/variables" class="block text-sm text-brand-blue hover:text-blue-800 transition-colors">
